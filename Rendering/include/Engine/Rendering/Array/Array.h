...
namespace Engine::Rendering::Array
{
	...
	public:
		...
		virtual const std::vector<std::shared_ptr<Engine::Rendering::Buffer::VertexBuffer>>& GetVertexBuffers() = 0;
		virtual const std::shared_ptr<Engine::Rendering::Buffer::IndexBuffer>& GetIndexBuffer() = 0;
